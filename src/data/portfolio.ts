...
// Interfaces moved to src/types/portfolio.ts
...
export const portfolioData: PortfolioData = {
	personalInfo: {
		...
		objective:
			"Full-stack/Backend Engineer with ~2 years shipping Node.js and React applications. Currently delivering AP automation at Bizzi and targeting junior-to-middle roles where I can own API-first products, strengthen system design, and scale event-driven services on AWS.",
	},
	education: [
		{
