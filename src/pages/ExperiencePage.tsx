...
const ExperiencePage = () => {
  ...
  const uniqueCompanies = new Set(
    workExperience.map((experience) => experience.company),
  ).size;
  ...
  > = {
    Bizzi: {
      ...
      impact:
        "Improved reliability and UX for finance teams processing invoices at scale",
    },
    Cigro: {
      learnings: [
      ...
      impact:
        "Enabled stable messaging and billing for consumer apps under growth",
    },
    FSoft: {
      learnings: [
  ...
  const enhancedExperience = workExperience.map((experience) => {
    ...
    return {
      ...
      impact:
        meta.impact ?? "Delivered features and collaborated across the team",
    };
  });
      ...
      <div className="container-width">
        ...
        >
          ...
          <section className="relative max-w-6xl mx-auto">
            <motion.div
              className="absolute left-6 md:left-1/2 md:transform md:-translate-x-1/2 w-1 h-full bg-linear-to-b from-blue-500 via-purple-500 to-green-500 rounded-full origin-top"
            ...
            {enhancedExperience.map((experience, index) => (
              ...
              >
                <div className="absolute left-0 md:left-1/2 md:transform md:-translate-x-1/2 w-12 h-12 rounded-2xl z-10 flex items-center justify-center">
                  ...
                  <Building
                    size={18}
                    className="relative text-sky-700 dark:text-sky-300"
                  />
                </div>
                ...
                >
                  ...
                  >
                    <Card className="glass-panel border border-gray-200 dark:border-gray-800 overflow-hidden relative">
                      <div
                        aria-hidden="true"
                        className="absolute -top-24 -right-24 h-64 w-64 rounded-full bg-(--brand-hero) blur-3xl opacity-10"
                      />
                              ...
                              {experience.contributions.map(
                                (contribution, idx) => (
                                  ...
                                  >
                                    <CheckCircle
                                      size={14}
                                      className="text-sky-700 dark:text-sky-300 mt-0.5 shrink-0"
                                    />
              ...
              <CardContent className="relative z-10 p-8 md:p-12">
                <div className="flex justify-center mb-6">
                  <div className="relative inline-flex items-center justify-center w-20 h-20 rounded-2xl">
                    <div
                      aria-hidden="true"
                      className="absolute -inset-3 rounded-3xl bg-(--brand-hero) blur-2xl opacity-30"
                    />
                    <div className="relative inline-flex items-center justify-center w-20 h-20 bg-white/80 dark:bg-gray-900/40 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-xl shadow-slate-900/10">
                      <Users
                        size={32}
                ...
                <p className="text-lg text-gray-700 dark:text-gray-200 mb-8 max-w-2xl mx-auto leading-relaxed">
                  ...
                  <span className="font-semibold text-sky-700 dark:text-sky-300">
                    Fresher/Junior Full-Stack Developer
                  </span>{" "}
                  position where I can keep growing while shipping reliable,
                  ...
                  <Card className="glass-panel border border-gray-200 dark:border-gray-800 rounded-2xl">
                    <CardContent className="p-6 text-center">
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-300">
                        Scalable, maintainable modern stack
                      </p>
                    </CardContent>
                  </Card>
