  ...
  const academicAchievements = [
    {
      ...
      description:
        "Specialized in full-stack development with focus on modern web technologies",
    ...
    },
    {
      ...
      description:
        "Mastered diverse technology stack from frontend to cloud deployment",
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-20">
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Comprehensive software engineering education with hands-on project
              experience
            </motion.p>
            ...
            >
              {education.map((edu, index) => (
                <motion.div
                  ...
                  variants={itemVariants}
                  transition={
                    shouldReduceMotion ? { duration: 0 } : TRANSITION.slow
                  }
                  className="mb-6"
                >
                  <Card className="glass-panel border border-slate-200/70 dark:border-slate-800/70 overflow-hidden relative">
                    <div
                      aria-hidden="true"
                      className="absolute -top-24 -right-24 h-72 w-72 rounded-full bg-(--brand-hero) blur-3xl opacity-10"
                    />
                          ...
                          <div className="rounded-2xl p-6 border border-slate-200/70 dark:border-slate-800/70 bg-white/60 dark:bg-slate-950/30">
                            ...
                            <ul className="space-y-2 text-slate-700 dark:text-slate-200">
                              <li className="flex items-start space-x-2">
                                <Target
                                  size={14}
                                  className="text-sky-700 dark:text-sky-300 mt-1 shrink-0"
                                />
                                <span>
                                  Specialized in full-stack web development and
                              ...
                              <li className="flex items-start space-x-2">
                                ...
                                />
                                <span>
                                  Led multiple capstone projects using modern
                        ...
                        <div className="lg:col-span-1">
                          ...
                          <div className="grid grid-cols-1 gap-4">
                            {academicAchievements.map((achievement, idx) => (
                              <div
                                key={idx}
                                className="text-center p-4 rounded-2xl border border-slate-200/70 dark:border-slate-800/70 bg-white/60 dark:bg-slate-950/30"
                              >
              ...
              {certifications.map((cert, index) => (
                <motion.div
                  ...
                  transition={
                    shouldReduceMotion
                      ? { duration: 0 }
                      : { ...TRANSITION.base, delay: index * 0.06 }
                  }
                  {...hoverLift(shouldReduceMotion)}
                  variants={itemVariants}
                  className="relative"
                >
                  <Card className="glass-panel border border-slate-200/70 dark:border-slate-800/70 overflow-hidden relative">
                    <div
                      aria-hidden="true"
                      className="absolute -top-24 -right-24 h-56 w-56 rounded-full bg-(--brand-hero) blur-3xl opacity-10"
                    />
          ...
          <motion.div variants={itemVariants}>
            <Card className="glass-panel border border-slate-200/70 dark:border-slate-800/70 overflow-hidden max-w-5xl mx-auto">
              ...
              <CardContent className="relative z-10 p-10 md:p-12 text-center">
                ...
                <h3 className="text-3xl md:text-4xl font-bold text-slate-950 dark:text-white mb-6">
                  Lifelong Learning Mindset
                </h3>

                <p className="text-lg text-slate-700 dark:text-slate-200 leading-relaxed max-w-3xl mx-auto mb-10">
                  Education is about building the ability to adapt, innovate,
                  and solve real problems. I keep learning to stay current with
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <Card className="glass-panel border border-slate-200/70 dark:border-slate-800/70 rounded-2xl">
                    <CardContent className="p-6 text-center">
                      <BookOpen
                        size={24}
                        className="text-sky-700 dark:text-sky-300 mx-auto mb-3"
                      />
                      <h4 className="font-semibold text-slate-950 dark:text-white mb-2">
                        Knowledge Seeking
                      </h4>
                      <p className="text-sm text-slate-600 dark:text-slate-300">
                        Explore new tools & methodologies
                      </p>
                    </CardContent>
                  </Card>
