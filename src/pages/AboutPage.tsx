          ...
          >
            ...
            >
                ...
                <div className="relative inline-block">
                  ...
                  <div className="relative w-36 h-36 md:w-44 md:h-44 mx-auto">
                    ...
                    <motion.div
                      ...
                      animate={
                        shouldReduceMotion ? undefined : { scale: [1, 1.15, 1] }
                      }
                      transition={
                        shouldReduceMotion
                          ? { duration: 0 }
              ...
              >
                ...
                crafting clean, reliable products.
              </motion.p>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                    ...
                    >
                      <p className="text-base md:text-lg text-slate-700 dark:text-slate-200 leading-relaxed mb-5">
                        As a Software Engineering graduate from FPT University,
                        I focus on creating impactful digital solutions. With
                        hands-on experience in full-stack development, I
                      ...
                      <p className="text-base md:text-lg text-slate-700 dark:text-slate-200 leading-relaxed mb-7">
                        My journey in tech began with curiosity and has evolved
                        into expertise across the stack. I thrive on{" "}
                        <span className="font-semibold text-sky-700 dark:text-sky-300">
                          innovative problem-solving
                        </span>{" "}
                        and creating user-centric applications using
                        technologies like React.js, Node.js, and cloud
                        platforms.
                      </p>
                    ...
                    >
                      <div className="relative w-full max-w-sm">
                        <div
                          className="absolute -inset-4 rounded-3xl bg-(--brand-hero) blur-2xl opacity-20"
                          aria-hidden="true"
                        />
            ...
            <motion.section variants={itemVariants} className="mb-16 sm:mb-20">
              <motion.h2
                variants={itemVariants}
                className="text-3xl md:text-4xl font-bold text-slate-950 dark:text-white text-center mb-3"
              >
                Technical Strengths
              </motion.h2>
              <motion.p
                variants={itemVariants}
                className="text-base md:text-lg text-slate-600 dark:text-slate-300 text-center mb-10 max-w-2xl mx-auto"
              >
                A practical toolkit for shipping and scaling modern web
                applications.
              </motion.p>
            ...
            <motion.section variants={itemVariants}>
              ...
              <motion.p
                ...
                className="text-base md:text-lg text-slate-600 dark:text-slate-300 text-center mb-10 max-w-2xl mx-auto"
              >
                Academic achievements and recognition that reflect consistency
                and ownership.
              </motion.p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {awards.map((award, index) => (
                  <motion.div
                    ...
                    initial={{
                      opacity: 0,
                      x: shouldReduceMotion ? 0 : index % 2 === 0 ? -18 : 18,
                    }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={
                      shouldReduceMotion
                        ? { duration: 0 }
                        : { ...TRANSITION.base, delay: index * 0.08 }
                    }
                    whileHover={shouldReduceMotion ? undefined : { y: -4 }}
                  >
                    <Card className="border border-slate-200/70 dark:border-slate-800/70 overflow-hidden">
                      <CardContent className="p-6 relative">
                        <div
                          aria-hidden="true"
                          className="absolute -top-12 -right-12 h-32 w-32 rounded-full bg-(--brand-hero) blur-2xl opacity-10"
                        />
